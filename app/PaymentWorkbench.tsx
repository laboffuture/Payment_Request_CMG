...
const statusTone=(s:string)=>s==="Query Raised"?"amber":s.includes("Observation")||s.includes("Rejected")?"red":s.includes("Closed")||s.includes("Released")?"green":s.includes("Audit")?"blue":s.includes("Finance")?"violet":"amber";
